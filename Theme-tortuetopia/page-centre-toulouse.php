...
<section class="centre-info-section">
  <div class="centre-info-inner">
    <div class="centre-logo">
      <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/logo_tortue.png' ); ?>" alt="Logo Centre Paris">
    </div>
    
    <div class="centre-info-card">
      <p>Le centre de Toulouse accueille les tortues blessées ou issues de sauvetages en milieu urbain. Notre équipe y assure les premiers soins, la réhabilitation et la préparation à l'adoption.</p>
...
<section class="centre-image-section">
  <div class="centre-image-inner">
    <div class="centre-image-card">
      <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/centre-toulouse.png' ); ?>" alt="Centre de Toulouse">
    </div>
  </div>
</section>
